...
このプロジェクトで最も効果的に学ぶ方法は、デモを実行しながら各シナリオの解説ドキュメントを並べて読むことです。各デモの結果が表示されたら、下の表から対応する解説を開いて、**なぜ**そのような結果になるのかを理解しましょう。
...
インデックスやEXPLAIN ANALYZEが初めての方は[インデックスの基礎](docs-jp/index-basics.md)から始めてください。
